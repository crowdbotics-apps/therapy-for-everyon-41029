...
## Project Structure
    ...
    ├── therapy_for_everyon_41029  # Django project configurations
...
1. Clone this repo and `cd therapy_for_everyon_41029`
...
2. Clone this repo and `cd therapy_for_everyon_41029`
